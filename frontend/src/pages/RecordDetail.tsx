            ...
            {record.status === 'transcribing' && (
              <div className="mb-3 p-3 bg-muted/50 rounded-md space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  {record.transcription_progress && record.transcription_progress.totalChunks > 1 && (
                ...
                <div className="w-full bg-muted rounded-full h-2 overflow-hidden">
                  {record.transcription_progress && record.transcription_progress.percent > 0 ? (
                    <div
                      className="bg-blue-600 h-full rounded-full transition-all duration-500 ease-out"
                      style={{ width: `${record.transcription_progress.percent}%` }}
                    />
                  ) : (
